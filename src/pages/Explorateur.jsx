                            ...
                            <tr key={i} className={couleur(p)}>
                              ...
                              <td className={styles.prix}>
                                {(() => {
                                  ...
                                  } else if (ecoSite != null) {
                                    return <span style={{color:'#f97316', fontWeight:700}}>{ecoSite.toFixed(2)} €</span>
                                  } else if (ecoExcel != null) {
                                    return <span style={{color:'#22c55e', fontWeight:700}}>{ecoExcel.toFixed(2)} €</span>
                                  }
                                  return null
                                })()}
                    ...
                    return colonnesExcel.filter(c => c && c.trim()).map((col, i) => {
                      ...
                      if (match(col, ['REFERENCE','REF','SKU','CODE']))
                        ...
                        if (ecoSite != null && ecoExcel != null) {
                          ...
                          val = <span style={{color:'#f97316', fontWeight:700}}>{ecoSite.toFixed(2)} €</span>
                        } else if (ecoExcel != null) {
                          val = <span style={{color:'#22c55e', fontWeight:700}}>{ecoExcel.toFixed(2)} €</span>
                        } else {
                          val = '—'
                        }
                      }
